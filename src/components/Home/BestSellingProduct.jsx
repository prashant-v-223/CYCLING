          ...
          <div className="row gy-4">
            ...
            {data.map((e, i) => {
              if (e.VariantCompareAtPrice !== "" && e.Title !== "") {
                let data = ((e.VariantCompareAtPrice - e.VariantPrice) / e.VariantCompareAtPrice) * 100
                return (
                    ...
                    <div className="product-card hover-btn">
                      <div className="product-card-img double-img">
                        ...
                        <div className="view-and-favorite-area">
                          <ul>
                            <li>
                              <a data-bs-toggle="modal" data-bs-target="#product-view" onClick={() => {
                                setselectesdata(e)
                              }}>
                  ...
                  <div className="col-lg-6">
                    <div className="shop-details-content">
                      ...
                      <div className="shop-details-btn">
                        <Link legacyBehavior href="/checkout"><a className="primary-btn1 hover-btn3" onClick={() => {
                          let olddata = JSON.parse(localStorage.getItem("carditams")) ? JSON.parse(localStorage.getItem("carditams")) : []
                          let dataaxist = JSON.parse(localStorage.getItem("carditams"))?.find((item) => {
                            return item?.Title === e?.Title;
                          })
                        ...
                        }}>*Buy Now*</a></Link> <Link legacyBehavior href="/shop/cart"><a className="primary-btn1 hover-btn3" onClick={() => {
                          let olddata = JSON.parse(localStorage.getItem("carditams")) ? JSON.parse(localStorage.getItem("carditams")) : []
                          let dataaxist = JSON.parse(localStorage.getItem("carditams"))?.find((item) => {
                            return item?.Title === e?.Title;
                          })
