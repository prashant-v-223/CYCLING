          ...
          <ul className={`sub-menu ${ state.activeMenu === "home-one" ? "d-block" : ""}`}>
                ...
                <div className="megamenu-wrap">
                    ...
                    <ul className="menu-row">
                        ...
                        <ul>
                            ...
                            <li>
                            <Link legacyBehavior href="/"><a>Shop List</a></Link>
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            <li>
                            <Link legacyBehavior href="/"><a>Filter Hidden</a></Link>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                            <Link legacyBehavior href="/"><a>Pagination</a></Link>
                            </li>
                            <li>
            ...
            <div className="search-area">
                ...
                <form>
                    ...
                    <h6>Quick Search :</h6>
                    <ul>
                        <li><Link legacyBehavior href="/"><a>Face,</a></Link></li>
                        <li><Link legacyBehavior href="/"><a>Body,</a></Link></li>
                        <li><Link legacyBehavior href="/"><a>Makeup,</a></Link></li>
                        <li><Link legacyBehavior href="/"><a>Hair</a></Link></li>
                    </ul>
                    </div>
                </form>
                </div>
