...
const checkout = () => {
    ...
    const [time, setTime] = useState(initialTime); const [payment, setPayment] = useState("");
    useEffect(() => {
            ...
            <div className="card px-3 py-4 mb-2" id="price-detail">
                ...
                <div className="price-detail-div mt-2">
                    <div className="product-price-list my-3">
                        ...
                        <span className="data selling_price me-0 td-none">₹ {Number(cartTotalPrice) || 0}</span>
                    </div>
                    <div className="product-price-list my-3">
                    ...
                    <div className="product-price-list mt-3 pt-3 total">
                        ...
                        <span className="data selling_price">₹ {Number(cancelcartTotalPrice) || 0}</span>
                    </div>
                </div>
            </div>
            <div className="">
